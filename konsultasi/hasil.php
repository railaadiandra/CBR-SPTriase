                ...
                <div style="margin-top:20px">
                    ...
                    <?php
                        ...
                        if($MAX==$proses1){
                            ...
                            echo "<div class='text-info' style='margin-top:10px;'><font face='Comic Sans MS, cursive'>Anda Masuk Dalam label Triase : <b class='text-error'><u>$dp[nama_penyakit]</u></b></font></div>";
